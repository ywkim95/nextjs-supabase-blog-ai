    ...
    <div className="mt-8 bg-white shadow rounded-lg">
      <div className="px-6 py-8">
        ...
        {user ? (
          ...
          <div className="mb-6 text-center p-4 border rounded-lg bg-gray-50">
            <p className="mb-3 text-gray-600">Log in to leave a comment.</p>
            <button
              onClick={handleGitHubLogin}
              className="inline-flex items-center justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
